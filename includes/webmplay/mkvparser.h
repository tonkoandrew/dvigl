...
public:
    ...
    long ParseContentEncAESSettingsEntry(
...
struct MasteringMetadata
{
    ...
    static bool Parse(
        IMkvReader* reader, long long element_start, long long element_size, MasteringMetadata** mastering_metadata);
...
private:
    ...
    long ParseTrackEntry(long long payload_start, long long payload_size, long long element_start,
        long long element_size, Track*&) const;
};
...
public:
    ...
    Chapters(
        Segment*, long long payload_start, long long payload_size, long long element_start, long long element_size);
